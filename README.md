...
through [plugins](https://github.com/Qwerty-Space/uniborg/tree/master/stdplugins)
which you can enable or disable on demand.

Each plugin gets the `borg`, `logger` and `storage` magical
[variables](https://github.com/Qwerty-Space/uniborg/blob/4805f2f6de7d734c341bb978318f44323ad525f1/uniborg/uniborg.py#L66-L68)
...
[`uniborg/`](https://github.com/Qwerty-Space/uniborg/tree/master/uniborg)
directory, with some utilities, enhancements and the core plugin.

## learning

Check out the already-mentioned
[plugins](https://github.com/Qwerty-Space/uniborg/tree/master/stdplugins)
